...
importlib.import_module("5_preprocessing2")
importlib.import_module("6_merge_sources2")
importlib.import_module("7_split_sets")
# importlib.import_module("8_1_NN")
# importlib.import_module('8_2_RF')
# importlib.import_module('8_3_SVM')
